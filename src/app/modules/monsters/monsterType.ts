...
import { monster_boss_slime } from './monster_boss_slime/monster_boss_slime'



export type monsterType = monster_zombie | monster_crystal | monster_skeleton | monster_hog | monster_mummy | monster_boss_slime;
